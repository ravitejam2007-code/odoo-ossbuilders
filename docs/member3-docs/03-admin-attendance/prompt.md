# Master Build Prompt - Phase 3 - Admin Attendance Management
...
1. Employee-aware attendance table/grid
1. Daily view
1. Weekly view
1. Status indicators for Present/Absent/Half-day/Leave
1. Date navigation/filter controls
1. Loading/error/empty states
1. Optional employee selection/filter only if supported by contract
1. Consistent time/date formatting
